...
class CostEstimator:
    ...
    def calculate_market_impact(self, quantity: int, avg_daily_volume: int) -> float:
    ...
    def estimate_total_cost(
        ...
        stt_rate = 0.000125 if market_state.get('instrument_type', 'FUT') == 'FUT' else 0.000625
        ...
        total = brokerage + stt + exchange + gst + sebi + stamp_duty + slippage + market_impact
