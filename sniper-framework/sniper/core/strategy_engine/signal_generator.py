"""Signal generation from OHLCV bars and regime (EMA, RSI, MACD)."""
...
from sniper.schemas.common import Direction, Regime
...
class SignalGenerator:
    """Generates trading signals from price/volume and regime."""
